...
// example 1: Metric prefix conversion
let a_1L = 1.0<L>
...
// example 5: Kilchhoff's circuit laws
let v = 4.0<V>
let i = 0.5<A>
let r = 5.0<Ohm>
let q = 0.3<C>
...
// example 6: various units conversion
